...
export default function EditScreen({ SaveEditFood, CheckIngFood, CheckEvalFood, CheckTimeFood, CheckFoodName, editFoods, nameErrorMessage, timeErrorMessage, evalErrorMessage, ingErrorMessage, checked, onPickerValueChange, onRadioButtonChecked }) {
    return (
            ...
            {editFoods &&
                <View>
                    ...
                    <View style={{ alignSelf: 'flex-end', marginTop: 30 }}>
                        <TouchableOpacity onPress={SaveEditFood}>
                            <Image
